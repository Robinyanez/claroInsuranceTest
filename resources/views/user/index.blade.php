                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-12 col-md-12">
                            ...
                            <a href="{{ route("user.createmsg") }}" type="button" class="btn btn-primary float-sm-right">
                                Crear nuevo Correo
                            </a>
                        </div>
                    </div>
                        ...
                        <tbody>
                            @foreach ($users as $item)
                                <tr>
                                    ...
                                    <td>
                                        @if ($item->status==='A')
                                            <a type="button" href="{{ route("user.showmsg", $item->id) }}" class="btn btn-outline-primary">Ver</a>
                                        @else
