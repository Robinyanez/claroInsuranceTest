                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('identification_card') is-invalid @enderror" id="identification_card"
                                        name="identification_card" value="{{ old('identification_card') }}" required placeholder="Cédula...">
...
{{-- <script>
    $("#province").change(function(){
        $.ajax({
            url: "{{route('admin.getcity')}}?id_provinces="+$(this).val(),
            method: 'GET',
            success: function(data) {
                $('#id_cities').html(data.html);
            }
        });
    });
</script> --}}
