...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $users_id = $this->route()->parameter('admin'); /* Obtenemos el id para la actualizacion de datos */

        return [
            'name'                  => 'required|max:100',
            'identification_card'   => 'required|digits:10|numeric|unique:users,identification_card,'.$users_id,
            'email'                 => 'required|email|unique:users,email,'.$users_id,
